...
level_url = credentials[3]["url"]
level_username = credentials[3]["level"]
level_password = credentials[3]["password"]
direct_url = level_url + "/s3cr3t/users.txt"

next_level_username = credentials[4]["level"]
